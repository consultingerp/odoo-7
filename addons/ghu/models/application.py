...
class GhuApplication(models.Model):
    ...
    def create_sign_request(self, record):
        ...
        sign_request.message_subscribe([3,7,11])
    ...
    def finish_application(self):
        ...
        enrollment.message_subscribe([3,7,11,3292])

# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'base_automation', 'web', 'crm', 'account', 'website', 'website_form', 'website_partner', 'website_form_editor', 'website_sale', 'hr', 'sign', 'mass_mailing', 'theme_treehouse', 'account_transferwise'],
